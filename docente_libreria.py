...
if __name__ == '__main__':
    d1 = Docente(cedula = '0917236663', nombre = 'JOSE', apellido= 'CORDOVA', email='jscordovaa@gmail.com', telefono='0982222920', direccion='LA JOYA', numero_libros=0, activo=True, carrera='ISAC', titulo_3er_nivel='ING', titulo_4to_nivel=',MAE')
    d2 = Docente(cedula = '0917236663', nombre = 'GUILLERMO', apellido= 'VALAREZO', email='jscordovaa@gmail.com', telefono='0982222920', direccion='LA JOYA', numero_libros=0, activo=True, carrera='ISAC', titulo_3er_nivel='ING', titulo_4to_nivel=',MAE')
